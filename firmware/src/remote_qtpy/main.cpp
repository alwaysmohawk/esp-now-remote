// ==========================================================================
// Remote (TX) — Adafruit QT Py ESP32-S3
...
// ---------------------------------------------------------------------------
// Pin Definitions — Adafruit QT Py ESP32-S3
// ESP32-S3 supports deep sleep GPIO wakeup on GPIO 0–21
// ---------------------------------------------------------------------------
#define BTN_1_PIN  18  // A0 on QT Py silkscreen
#define BTN_2_PIN  17  // A1 on QT Py silkscreen
#define BTN_3_PIN  9   // A2 on QT Py silkscreen
#define BTN_4_PIN  8   // A3 on QT Py silkscreen
...
void setup() {
    ...
    Serial.begin(115200);
    delay(100);
    Serial.println("Remote (QT Py S3) booting...");
    #endif
